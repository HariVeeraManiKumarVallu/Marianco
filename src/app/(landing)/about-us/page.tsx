            ...
            <div className="flex flex-col md:flex-row gap-8 mt-8 mx-auto max-w-prose md:max-w-none">
              ...
              <div className="max-w-prose">
                <p className="mb-8">
                  ...
                  trafficking, child prostitution, and child pornography. We
                  care for all children and provide even extra careful support
                ...
                <p className="">
                  ...
                  exploitation of young children. Our organization was founded
                  by individuals who could not stand by while children across
                  the world continued to suffer from the horrors of trafficking,
                  exploitation, and abuse. Through targeted interventions,
                  powerful advocacy, and hands-on support, Marianco seeks to
                  protect the most vulnerable children, ensuring they have a
                  safe space to grow, thrive, and reclaim their lives.
                </p>
              </div>
            </div>
          </div>
