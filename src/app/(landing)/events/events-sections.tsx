...
export default function EventsSection({ events }: { events: EventInfo[] }) {
  return (
    <section>
           ...
           "
                ...
                <CardContent className="lg:py-12 lg:max-w-[450px] text-pretty">
                  ...
                  <p className="mb-8">
                    ...
                    Excepturi, neque possimus iure laborum ea perspiciatis.
                    Officiis, fugit neque. Enim quisquam, ipsum temporibus
                    expedita ipsa vel ad doloremque magni sit dicta excepturi
                    incidunt esse necessitatibus mollitia libero deleniti.
                    Nihil, minus culpa.
                  </p>
