const About = () => {
  return (
    <>
      <h1 className="container center">About Us</h1>
      <section className="container">
        ...
        <p>
          ...
          Maria, was a child prostitute living in the Cartagena slums.
        </p>
        <p>
          We are dedicated to combating child trafficking, child prostitution,
          and child pornography. We care for all children and provide even extra
          careful support for children under the age of 15.
        </p>
        <p>
          With a deep personal connection to our mission, we strive to provide
          safety, support, and hope to children in need.
        </p>
        <p>
          The Marianco team is on a mission to eradicate the sexual exploitation
          of young children. Our organization was founded by individuals who
          could not stand by while children across the world continued to suffer
          from the horrors of trafficking, exploitation, and abuse.
        </p>

        <p>
          Through targeted interventions, powerful advocacy, and hands-on
          support, Marianco seeks to protect the most vulnerable children,
          ensuring they have a safe space to grow, thrive, and reclaim their
          lives.
        </p>
      </section>
      <section className="container">
      ...
      <section className="container">
        ...
        <p>
          ...
          diverse team works across sectors to bring lasting change and justice
