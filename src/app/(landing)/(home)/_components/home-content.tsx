...
import FeaturedArticles from '../../articles/featured-articles-section'
...
export default function HomeContent() {
  return (
    <div className="space-y-page bg-beige ">
      ...
      <section className="space-y-section bg-brand-white">
          ...
          >
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground">
                  Join us in our mission. Discover and participate in our
